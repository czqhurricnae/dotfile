...
hs.hotkey.bind(hyper, "X", showAppKeystroke)
...
-- Window operations.
hs.hotkey.bind("cmd", 'U', resizeToCenter)
...
hs.hotkey.bind("cmd", "J", moveToBottomHalf)
hs.hotkey.bind("cmd", "K", moveToTopHalf)
-- hs.hotkey.bind("cmd", "Z", moveToFullSize)
